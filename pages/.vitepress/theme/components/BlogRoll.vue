...
<template>
  <ScrollableCenter>
    ...
    <ArticleCard @filter-tag-clicked="(e) => add_filter(e)"
      ...
      :filter_tags="filters" :url="post.url" :image_url="post.image_url ? post.image_url : '/assets/logo.svg'"
      :date="post.date.string" :excerpt="post.excerpt ? post.excerpt : ''" :tags="post.tags" :title="post.title">
    </ArticleCard>
  </ScrollableCenter>
</template>