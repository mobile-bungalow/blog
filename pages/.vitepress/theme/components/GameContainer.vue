...
<svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" viewBox="0 0 49 60">
  ...
  <g id="Rectangle_4" data-name="Rectangle 4" transform="translate(27)" fill="#fff" stroke="#707070" stroke-width="1">
    <rect width="22" height="60" stroke="none"/>
    <rect x="0.5" y="0.5" width="21" height="59" fill="none"/>
  </g>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" width="43" height="49" viewBox="0 0 43 49">
  <g id="Polygon_1" data-name="Polygon 1" transform="translate(43) rotate(90)" fill="#fff">
    <path d="M 48.13965225219727 42.5 L 0.8603482842445374 42.5 L 24.5 1.00999903678894 L 48.13965225219727 42.5 Z" stroke="none"/>
    <path d="M 24.5 2.019989013671875 L 1.720691680908203 42 L 47.2793083190918 42 L 24.5 2.019989013671875 M 24.5 0 L 49 43 L 0 43 L 24.5 0 Z" stroke="none" fill="#707070"/>
  </g>
</svg>
            </button>
        </div>
